...
# Install PyQt
$PYTHON -m pip install PyQt5==5.10.1 -i https://pypi.tuna.tsinghua.edu.cn/simple
...
# install Cryptodome
$PYTHON -m pip install pycryptodomex==3.5.1 -i https://pypi.tuna.tsinghua.edu.cn/simple
